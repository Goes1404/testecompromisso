...
async function main() {
  ...
  console.log(`Found ${allStudents.length} students. Updating all passwords to 'compromisso2026' and setting must_change_password...`);
  ...
  for (let i = 0; i < allStudents.length; i++) {
    ...
    // Attempt to set both password and user metadata
