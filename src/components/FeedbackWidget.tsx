      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-44 right-6 lg:bottom-24 lg:right-6 z-[90] h-11 w-11 bg-primary text-white rounded-full shadow-[0_10px_25px_-5px_rgba(255,107,0,0.5)] flex items-center justify-center border-2 border-white/20 glow-orange group overflow-hidden"
