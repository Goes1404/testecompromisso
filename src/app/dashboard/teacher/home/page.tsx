      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          ...
          <Link key={i} href={stat.href} className="block">
            <div className="bg-white rounded-2xl p-4 md:p-5 shadow-sm border border-slate-100 hover:shadow-lg hover:-translate-y-0.5 active:scale-[0.97] transition-all [touch-action:manipulation]">
