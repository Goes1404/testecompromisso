...
export default function LandingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-gray-950 selection:bg-primary/20 selection:text-primary scroll-smooth snap-y snap-mandatory">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[110] bg-white animate-in slide-in-from-right duration-500 md:hidden">
          ...
          <div className="p-10 space-y-6">
            <Link href="#metodologia" className="block text-xl font-black text-gray-800" onClick={() => setMobileMenuOpen(false)}>Metodologia</Link>
            <Link href="#resultados" className="block text-xl font-black text-gray-800" onClick={() => setMobileMenuOpen(false)}>Resultados</Link>
            <div className="pt-8">
              <Button asChild className="w-full bg-primary h-14 rounded-full border-none text-lg font-black shadow-xl shadow-primary/20">
                <Link href="/login">Portal do Aluno</Link>
              </Button>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center relative z-10 w-full pt-6 md:pt-10">
            <div className="space-y-4 md:space-y-6 animate-in fade-in slide-in-from-left duration-1000">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <Button asChild className="h-11 px-8 bg-primary hover:bg-[#e06000] text-white font-black text-sm rounded-full shadow-lg shadow-primary/20 border-none transition-all active:scale-95 group">
                  <Link href="/login" className="flex items-center gap-2">
                    Acessar Meu Portal <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                  </Link>
                </Button>
                <Button asChild variant="outline" className="h-11 px-8 bg-transparent text-white font-black text-sm rounded-full border border-white/20 hover:bg-white/5 transition-all">
                  <Link href="#metodologia" className="flex items-center gap-2">
