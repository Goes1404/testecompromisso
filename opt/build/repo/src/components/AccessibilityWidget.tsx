...
export function AccessibilityWidget() {
  ...
  return (
    <div 
      className={`fixed ${isInputHeavyPage ? 'bottom-28 md:bottom-10' : 'bottom-6'} right-6 z-[9999] flex flex-col gap-3 transition-all duration-1000 ease-in-out md:cubic-bezier(0.4, 0, 0.2, 1) ${
        isOpen 
          ? '-translate-x-[calc(100vw-5.5rem)] items-start' 
          : 'translate-x-0 items-end'
      }`}
    >
